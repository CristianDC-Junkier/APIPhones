    ...
    return (
        <div className="border-top border-2 border-dark mb-0">
            ...
            <Table
                ...
                responsive
                size="sm"
                className="mb-0 small text-center border-dark border-2 table-striped table-hover"
            >
                <tbody>
                    ...
                    {trabajadoresDepartamento.map((t, idx) => (
                        <tr key={idx} className="small text-center">
                            ...
                            <td style={{ width: "40%" }} className="text-uppercase email">{t.email}</td>
                        </tr>
                    ))}
                        ...
                        <React.Fragment key={idx}>
                            ...
                            {trabajadoresSubdepartamentos[idx]?.map((t, tIdx) => (
                                <tr key={tIdx} className="small text-center">
                                    ...
                                    <td className="text-uppercase email">{t.email}</td>
                                </tr>
                            ))}
                        </React.Fragment>
                    ))}
