        ...
        <Container fluid className="my-3 position-relative" style={{ paddingLeft: 0, paddingRight: 0 }}>
            ...
            <Row className="justify-content-center">
                ...
                <Col md="10" className="mb-3">
                    ...
                    Sus datos personales se usarán para atender peticiones relacionadas con el <strong>Listín telefónico</strong> y sólo el <strong>personal autorizado de la entidad</strong> tendrá acceso.<br />
